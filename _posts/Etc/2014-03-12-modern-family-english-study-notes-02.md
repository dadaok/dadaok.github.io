---
layout:   post
title:    "모던패밀리 영어공부 노트 02"
subtitle: "예문 전체 + 내가 궁금했던 포인트 정리"
category: Etc
more_posts: posts.md
tags:     [Etc, English, ModernFamily]
---

# 미드 영어 표현 정리

영어는 단어 하나씩 끊어 보기보다,
**예문 전체 → 핵심 뜻 → 내가 물어본 포인트** 순서로 정리하면 기억이 더 잘 난다.
...
#### 1) over은 무슨 뜻?
- 여기서는 **over**를 따로 보기보다 **over here**로 같이 봐야 한다.
- **over here** = **여기 이쪽에**
- `here`보다 **위치감**이 더 강하다.
...
- 즉, **over here**는 “저쪽 말고 이쪽” 같은 위치 강조가 있다.
...
#### which
- 여기서 **which**는 앞의 내용을 받아서 덧붙여 설명하는 역할
- 딱 한 단어보다:
- **그건**
- **그런데**
- **그 점에서**
...
### 포인트
- 여기서 **to**는 전치사라 뒤에 **being**처럼 동명사가 온다.
